  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute inset-0 [background-position:75%_40%] md:[background-position:center_40%]"
          style={{
        ...
        <div className="absolute bottom-6 right-6 flex items-center gap-1.5 bg-black/50 backdrop-blur-sm border border-white/10 rounded-full px-3 py-1.5">
          ...
          <span className="text-xs font-mono text-gray-300">Salzkammergut, Austria</span>
        </div>
      </div>

      <div className="max-w-7xl mx-auto">
        <SectionHeader label="About" title="Who I am" number="01" />
